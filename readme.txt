...
= 1.3.1 =
* tested for compatibility with last WordPress version

= 1.3.0 =
* text format for notifications for better deliverability
* filter settings fields for publish
* tested for compatibility with last WordPress version
...
= 1.2.1 =
* fix styles for cross-browser compatibility
